...
def generate_dataset(listings_csv_url, reviews_csv_url, city, entities, max_properties=150):
    ...
    for row in listings[:max_properties]:
        ...
        property_data = {
            ...
            "amenities": amenities,
            "photos": property_photos, # property photos
        ...
        for i in range(random.randint(3,5)):
            room_photos = [fake.image_url() for _ in range(random.randint(3,5))] # room photos
            room = {
                "id": fake.uuid4(),
                "property_id": property_id,
        ...
        for _ in range(random.randint(10,20)):
            ...
            reservation["room_id"] = random.choice(rooms_for_property)["id"] # link to room
